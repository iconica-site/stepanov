...
const reviewSlider = new core(".bankruptcy-reviews-slider", {
  modules: [Navigation, Pagination, Keyboard,],
  navigation: {
    prevEl: ".bankruptcy-reviews-arrows__arrow_left",
    nextEl: ".bankruptcy-reviews-arrows__arrow_right",
  },
  pagination: {
    el: ".bankruptcy-reviews-slider__pagination",
    clickable: true,
  },
  keyboard: {
    onlyInViewport: true,
...
const aboutThumbs = new core(".about-thumbs", {
  slidesPerView: 5,
  spaceBetween: 20,
});

const aboutSlider = new core(".about__slider", {
...
;// CONCATENATED MODULE: ./src/js/scripts/scripts/youtube.js
const youtubeBlocks = document.querySelectorAll(".youtube");
...
if (youtubeBlocks.length) {
  ...
  youtubeBlocks?.forEach(youtube => {
    const { video } = youtube.dataset;
    const button = youtube.querySelector(".youtube__play");
    ...
    if (video && button) {
      ...
      source.srcset = `https://i.ytimg.com/vi_webp/${video}/maxresdefault.webp`;
      source.type = "image/webp";
      img.src = `https://i.ytimg.com/vi/${video}/maxresdefault.jpg`;
      picture.insertAdjacentElement("afterbegin", source);
      picture.insertAdjacentElement("beforeend", img);
      youtube.insertAdjacentElement("afterbegin", picture);
      ...
      button.addEventListener("click", () => {
        ...
        function onPlayerReady(event) {
          if (matchMedia("(hover: none)").matches) event.target.mute();
